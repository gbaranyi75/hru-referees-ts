      ...
      <nav className="flex flex-col w-full min-h-screen">
        <div className="grow">
          ...
          <ul className="flex flex-col grow px-4 justify-between gap-1">
            ...
            <li className="py-0 pt-1 m-0 mb-2 border-b border-gray-300"></li>
      ...
      {item.subItems ? (
        <>
          <button
            ...
            className={`flex flex-row w-full p-2 mb-1 space-x-3 text-center text-sm font-semibold text-gray-600 items-center rounded-lg hover:bg-zinc-200
                ...
                return (
                  <li
                    ...
                    <Link
                      ...
                      rel="noreferrer"
                      className={`flex flex-row w-full p-2 space-x-3 text-center text-sm font-semibold text-gray-600 items-center rounded-lg hover:bg-zinc-200
