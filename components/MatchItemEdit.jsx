...
const MatchItemEdit = ({ resetEditMode, match }) => {
  console.log(match);
  const defaultFormFields = {
    ...
    assist1: match.assist1,
    assist2: match.assist2,
    ...
    if (type === "7s" || type === "UP torna") {
      ...
      if (
        ...
        try {
          console.log(formFields)
          //await createMatch(formFields);
          router.push("/dashboard/matches/edit");
          //resetFormFields();
          //resetEditMode();
        } catch (error) {
          console.error(error.message);
          ...
          <div className="px-4 py-5 bg-white sm:p-6">
            <div className="md:grid grid-cols-2 gap-6">
              ...
              <div className="mb-6 md:mb-0">
                ...
                <Select
                  defaultValue={{ label: match.gender }}
                  className="mt-1 text-sm text-gray-700"
              ...
              <div className="mb-6 md:mb-0">
                ...
                <Select
                  defaultValue={{ label: match.venue }}
                  className="mt-1 text-sm text-gray-700"
              ...
              {isSingleMatch && (
                <>
                  <div className="mb-6 md:mb-0">
                    ...
                    <Select
                      defaultValue={{ label: match.referee.userName }}
                      className="mt-1 text-sm text-gray-700"
                  ...
                  <div className="mb-6 md:mb-0">
                    ...
                    <Select
                      defaultValue={{ label: match.assist1.userName }}
                      className="mt-1 text-sm text-gray-700"
                      placeholder="--Válassz a listából--"
                      onChange={handleRefChange}
                      options={users.map((ref) => ({
                  ...
                  <div className="mb-6 md:mb-0">
                    ...
                    <Select
                      defaultValue={{ label: match.assist2.userName }}
                      className="mt-1 text-sm text-gray-700"
                      placeholder="--Válassz a listából--"
                      onChange={handleRefChange}
                      options={users.map((ref) => ({
                  ...
                  <div className="mb-6 md:mb-0">
                    ...
                    <Select
                      defaultValue={match.controllers.map((ref) => {
                        {label: ref.userName}
                      })}
