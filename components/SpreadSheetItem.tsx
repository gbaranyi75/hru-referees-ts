...
const SpreadSheetItem = ({
  ...
  if (loading)
    return (
      <Skeleton className="flex flex-col border-b h-12 border-gray-300 mx-6 mt-5 bg-white text-gray-600 text-center drop-shadow-md hover:drop-shadow-xl justify-center z-0" />
    );

  return (
    <div className="flex flex-col mb-5 rounded-2xl border border-gray-200 mt-5 bg-white text-gray-600 text-center justify-center z-0">
      ...
      {isOpen && (
        <div className="col-span-12 mt-5 mb-10 md:justify-center overflow-x-auto relative z-1">
