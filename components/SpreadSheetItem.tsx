...
const SpreadSheetItem = ({
  ...
  return (
    <div className="flex flex-col mb-5 rounded-2xl border border-gray-200 mt-5 bg-white text-gray-600 text-center drop-shadow-sm hover:drop-shadow-lg justify-center z-0">
