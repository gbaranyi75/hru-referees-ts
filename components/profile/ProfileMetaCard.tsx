...
import { updateProfileData, updateProfileImage } from "@/lib/actions/profileActions";
...
export default function ProfileMetaCard({
  ...
  const handleFbUrlChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    setFbUrl(e.target.value);
  };

  const handleInstaUrlChange = (e: React.ChangeEvent<HTMLInputElement>) => {
            ...
            <div className="w-20 h-20 relative border border-gray-200 rounded-full">
              ...
              <div className="absolute top-16 left-7">
                <CldUploadButton
                  ...
                  className="inline-flex w-full cursor-pointer justify-center items-center p-1 rounded-md text-blue-600 bg-blue-100 opacity-70"
                  onSuccess={handleImageUpload}
                >
                  <span className="">
                    <Icon icon="lucide:image-up" width="16" height="16" />
                  </span>
                </CldUploadButton>
              </div>
            </div>
